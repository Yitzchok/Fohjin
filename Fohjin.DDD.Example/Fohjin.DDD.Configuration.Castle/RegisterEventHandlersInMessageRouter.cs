...
namespace Fohjin.DDD.Configuration.Castle
{
    public class RegisterEventHandlersInMessageRouter
    {
        ...
        {
            new RegisterEventHandlersInMessageRouter().RegisterRoutes(ServiceLocator.Current.GetInstance<IRouteMessages>() as MessageRouter);
        }
        ...
        {
            return ServiceLocator.Current.GetInstance(eventHandler);
        }
    }
}